...
## 서비스 핵심 기능
- **AI 부위 인식**: EfficientNet-B2 기반 모델을 통해 소/돼지 부위를 실시간 분석 (정확도 94.2%).
- **스마트 이력 조회**: 하이브리드 OCR(EasyOCR + PaddleOCR 파인튜닝)로 이력번호를 인식하여 사육·도축 정보 제공.
...
<img width="2530" height="1422" alt="image" src="https://github.com/user-attachments/assets/b51a995b-a2c0-4f17-9296-a8827c7ac963" />
